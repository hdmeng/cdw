...
# Bee Maps roadway-coverage heatmap layer. All of its logic lives in
# backend/beemaps_heatmap_api.py; this is the only hook it needs here.
import beemaps_heatmap_api
app.include_router(beemaps_heatmap_api.router)

# Vizzion cameras / trajectories / drive-heatmap layer.
import vizz_api
